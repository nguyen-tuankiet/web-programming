...
<div class="container">
    <div class="section1">
        <iframe src="${pageContext.request.contextPath}/home/Product-detail/Product-detail-item.jsp" class="iframe"></iframe>
    </div>
    <div class="section1">
        <iframe src="${pageContext.request.contextPath}/home/Product-detail/Product-buying-tool.jsp" class="iframe"></iframe>
    </div>
    <div>
        <a href="#"><button></button></a>
    </div>

    <a href="#"><button class="btn-add-to-cart btn add">Thêm vào giỏ hàng</button></a>
</div>

<div class="summary__list">
    <div class="summary__item">
        <img src="${pageContext.request.contextPath}/static/image/img-detail/icon1.jpg" alt="Icon 1" class="summary__icon">
...
<div class="carousel-container">
    ...
    <div class="carousel-slide">
        ...
        <img id="carousel-image" src="${pageContext.request.contextPath}/static/image/img-detail/carousel1.jpg" alt="Carousel Image" class="carousel-image">
...
<div class="feature-benefit">
    ...
    <div class="feature-benefit__video">
        <video autoplay muted loop playsinline preload="auto">
            <source src="//images.samsung.com/is/content/samsung/assets/vn/refrigerators/top-mount-freezer/optimal-fresh-plus/20231013/Che-do-lam-lanh_720x720.mp4" type="video/mp4">
        </video>
    </div>
</div>
<div class="iframe-container">
    <iframe src="${pageContext.request.contextPath}/home/Product-detail/Product-Feature.jsp" class="iframe-large"></iframe>
</div>
