...
<head>
    ...
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/static/style-component/account_settings/account_settings.css">
...
<%--                    </div>--%>
                ...
                <div class="content notifications" id="notifications">
                    ...
                    <div class="alert">
                        Chúng tôi cần quyền từ trình duyệt của bạn để hiển thị thông báo. <a href="#"
                                                                                             class="alert-link">Yêu
                        cầu
                        quyền</a>
                    </div>
            ...
            <div class="content social-accounts" id="social-accounts">
                ...
                <p>Các tính năng tích hợp từ các tài khoản này giúp bạn dễ dàng kết nối với bạn bè và chia sẻ cập
                    nhật.</p>
            ...
            <div class="content delete-account" id="delete-account">
                ...
                <p>Khi bạn xóa tài khoản, bạn sẽ mất quyền truy cập vào tất cả dịch vụ và chúng tôi sẽ xóa vĩnh viễn dữ
                    liệu
...
<script src="${pageContext.request.contextPath}/static/style-component/account_settings/account_settings.js"></script>
</html>
