...
<%--&lt;%&ndash;            <input type="text" placeholder="Tìm kiếm...">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <button type="submit"><i class="fa-solid fa-search"></i></button>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </div>&ndash;%&gt;--%>
<%--        <div class="menu row mid_align">--%>
<%--&lt;%&ndash;            <i class="fa-regular fa-bell"></i>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <i class="fa-regular fa-envelope"></i>&ndash;%&gt;--%>
